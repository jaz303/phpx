...
Nice to haves:
  ...
  * Stream wrappers are currently used to handle script loading. I can't remember why I took this approach and I'm not sure it's any better than simply reading the file using `file_get_contents()` 
